...
const MOCK_PROPERTIES: Record<number, object> = {
  1: {
    ...
    description: 'A comfortable and fully equipped studio apartment 5 minutes walk from the main gate of Assiut University. Rent includes electricity, water, and high-speed internet. The apartment is on the 3rd floor with a pleasant street view.',
    ...
    canBook: true,
    reviews: [
      { id: 1, studentName: 'Mohamed Khaled', rating: 5, comment: 'Great location and very clean. The landlord is very cooperative.', createdAt: '2024-11-01T00:00:00Z' },
      { id: 2, studentName: 'Sara Ahmed', rating: 4, comment: 'Good value for the price. WiFi could be faster.', createdAt: '2024-10-15T00:00:00Z' },
    ],
  ...
  2: {
    ...
    canBook: true,
    reviews: [
      { id: 3, studentName: 'Nora Mahmoud', rating: 5, comment: 'Very safe and clean. The management is excellent.', createdAt: '2024-10-20T00:00:00Z' },
    ],
