...
const MOCK_PROPERTIES: Record<number, object> = {
  1: {
    ...
    description: 'استوديو مريح ومجهز بالكامل على بعد 5 دقائق سيرًا من البوابة الرئيسية لجامعة أسيوط. يشمل الإيجار فاتورة الكهرباء والمياه وإنترنت عالي السرعة. الشقة في الدور الثالث بإطلالة جميلة على الشارع.',
    ...
    canBook: true,
    reviews: [
      { id: 1, studentName: 'محمد خالد', rating: 5, comment: 'موقع ممتاز ونظيف جداً. صاحب الشقة متعاون.', createdAt: '2024-11-01T00:00:00Z' },
      { id: 2, studentName: 'سارة أحمد', rating: 4, comment: 'قيمة جيدة مقابل السعر. الإنترنت يمكن أن يكون أسرع.', createdAt: '2024-10-15T00:00:00Z' },
    ],
  ...
  2: {
    ...
    description: 'غرفة آمنة ومريحة في مبنى مخصص للبنات، على بعد 10 دقائق من كلية الطب جامعة أسيوط. جميع الفواتير مشمولة في الإيجار. المبنى به حارسة أمن على مدار الساعة.',
    listingMode: 'Bed',
    price: 950,
    currency: 'EGP',
    ...
    canBook: true,
    reviews: [
      { id: 3, studentName: 'نورا محمود', rating: 5, comment: 'آمنة ونظيفة جداً. الإدارة ممتازة.', createdAt: '2024-10-20T00:00:00Z' },
    ],
