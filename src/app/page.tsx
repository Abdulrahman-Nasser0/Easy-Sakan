  ...
  return (
    <div className="bg-white">
      <style>{`
        ...
        @keyframes glowPulse {
          0%, 100% { opacity: 1; box-shadow: 0 0 4px 2px rgba(74, 222, 128, 0.5); }
          50% { opacity: 0.8; box-shadow: 0 0 16px 8px rgba(74, 222, 128, 0.8); }
        }
        .animate-gradient {
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-linear-to-r from-[#0071c2] via-[#005999] to-[#004a7d] animate-gradient">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="text-center">
            ...
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-8">
              <span className="w-2 h-2 rounded-full bg-green-400 mr-2 glow-dot"></span>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#1a1a2e] mb-4">The Easy Sakan Advantage</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: 'M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 4l4 2m-2-2l4-2', title: 'Premium Properties', desc: 'Handpicked luxury properties with verified listings and authentic reviews' },
              { icon: 'M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z', title: 'Expert Support', desc: '24/7 dedicated support team to assist with bookings and inquiries' },
              { icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', title: 'Best Value', desc: 'Competitive pricing with exclusive deals for registered members' },
            ].map((feat, i) => (
              <div key={i} className="text-center p-8 bg-white border border-gray-200 rounded-lg hover:border-[#0071c2]/50 transition-all shadow-sm">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e] mb-3">{feat.title}</h3>
      ...
      <div className="py-24 bg-[#ebf3ff]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1a1a2e] mb-4">Ready to Book Your Perfect Stay?</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-600">Your trusted platform for booking premium properties and accommodations worldwide.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#1a1a2e] mb-4">Quick Links</h4>
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/properties" className="hover:text-[#0071c2] transition-colors">Browse Properties</Link></li>
                <li><Link href="/" className="hover:text-[#0071c2] transition-colors">About Us</Link></li>
                <li><Link href="/" className="hover:text-[#0071c2] transition-colors">Support</Link></li>
              </ul>
            </div>
            {!isAuthenticated && (
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/login" className="hover:text-[#0071c2] transition-colors">Login</Link></li>
                <li><Link href="/signup" className="hover:text-[#0071c2] transition-colors">Sign Up</Link></li>
              </ul>
            </div>
            )}
            <div>
