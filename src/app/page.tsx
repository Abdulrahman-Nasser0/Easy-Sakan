...
export default function Home() {
  ...
  return (
    <div className="bg-slate-950">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-sky-900 via-slate-800 to-slate-900">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-sky-500/10 border border-sky-400/20 mb-8">
      ...
      <div className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 rounded-full bg-sky-900/50 border border-sky-600 text-sky-200 text-sm font-semibold mb-4">
              WHY CHOOSE US
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-sky-500/50 transition-all">
              <div className="w-16 h-16 bg-sky-500 rounded-lg flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Premium Properties</h3>
      ...
      {/* Stats Section */}
      <div className="py-16 bg-gradient-to-r from-sky-700 to-blue-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="text-white">
              ...
              <div className="text-sky-200">Properties</div>
            </div>
            <div className="text-white">
      ...
      <footer className="bg-slate-950 border-t border-slate-800 text-slate-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold text-white mb-4">Easy Sakan</h3>
