...
export default function AccountDropdown({isAuthenticated = false, userRole } : UserActionsProps) {
  const trigger = (
      ...
      <div className="py-2">
        ...
        {userRole !== 'Admin' && (
          <>
            ...
            <Link href="/settings" className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
